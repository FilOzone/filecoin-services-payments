...
- *Note:* Unlike streaming lockup the fixed lockup is *not* reserved. When an account spends out of fixed lockup it reduce the lockup requirement and the overall lockup for that account.
